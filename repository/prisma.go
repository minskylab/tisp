...
func (client *Client) UpdateManyStages(params StageUpdateManyParams) *BatchPayloadExec {
	exec := client.Client.UpdateMany(
		...
		[2]string{"StageUpdateManyMutationInput!", "StageWhereInput"},
		"updateManyStages")
	return &BatchPayloadExec{exec}
}
...
func (client *Client) DeleteManyStages(params *StageWhereInput) *BatchPayloadExec {
	exec := client.Client.DeleteMany(params, "StageWhereInput", "deleteManyStages")
	return &BatchPayloadExec{exec}
}
...
func (instance StagePreviousValuesExec) Exec(ctx context.Context) (*StagePreviousValues, error) {
	var v StagePreviousValues
	ok, err := instance.exec.Exec(ctx, &v)
	if err != nil {
		return nil, err
	}
...
func (instance StagePreviousValuesExecArray) Exec(ctx context.Context) ([]StagePreviousValues, error) {
	var v []StagePreviousValues
	err := instance.exec.ExecArray(ctx, &v)
	return v, err
}
...
func (instance StageSubscriptionPayloadExec) Exec(ctx context.Context) (*StageSubscriptionPayload, error) {
	var v StageSubscriptionPayload
	ok, err := instance.exec.Exec(ctx, &v)
	if err != nil {
		return nil, err
	}
...
func (instance StageSubscriptionPayloadExecArray) Exec(ctx context.Context) ([]StageSubscriptionPayload, error) {
	var v []StageSubscriptionPayload
	err := instance.exec.ExecArray(ctx, &v)
	return v, err
}
...
func (instance StageConnectionExecArray) Exec(ctx context.Context) ([]StageConnection, error) {
	var v []StageConnection
	err := instance.exec.ExecArray(ctx, &v)
	return v, err
}
